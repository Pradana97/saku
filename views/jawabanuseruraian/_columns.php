    ...
    [
        ...
        'buttons' => [
            'view' => function ($url, $model) {
                $t ='@web/jawabanuseruraian/view?id='.$model->id_jawabanuser;
            ...
            'update' => function ($url, $model) {
                $t = '@web/jawabanuseruraian/update?id=' . $model->id_jawabanuser;
            ...
            'delete' => function ($url, $model) {
                $t = '@web/jawabanuseruraian/delete?id=' . $model->id_jawabanuser;
