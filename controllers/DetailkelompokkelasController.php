...
use app\models\DetailkelompokkelasSearch;
use yii\web\{Controller,Response,NotFoundHttpException};
use yii\filters\VerbFilter;
use yii\helpers\{Html,Url,ArrayHelper};
class DetailkelompokkelasController extends Controller
{
    ...
    public function actionIndex(){    
        $searchModel = new DetailkelompokkelasSearch();
    ...
    public function actionCreate(){
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                return [
                    'title'=> "Create new Detailkelompokkelas",
                ...
                return [
                    ...
                    'title'=> "Create new Detailkelompokkelas",
                    'content'=>'<span class="text-success">Create Detailkelompokkelas success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id){
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                return [
                    'title'=> "Update Detailkelompokkelas #".$id,
    ...
    {
        if (($model = Detailkelompokkelas::findOne($id)) !== null) {
            return $model;
        } else {
