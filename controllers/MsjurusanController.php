...
class MsjurusanController extends Controller
{
    ...
    public function actionIndex(){    
        $searchModel = new MsjurusanSearch();
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new MsJurusan",
                    'content'=>'<span class="text-success">Create MsJurusan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {
        if (($model = MsJurusan::findOne($id)) !== null) {
            return $model;
        } else {
