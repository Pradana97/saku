...
use app\models\MsjabatanSearch;
...
class MsjabatanController extends Controller
{
    ...
    public function actionIndex(){    
        $searchModel = new MsjabatanSearch();
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new MsJabatan",
                    'content'=>'<span class="text-success">Create MsJabatan success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    {
        if (($model = MsJabatan::findOne($id)) !== null) {
            return $model;
        } else {
