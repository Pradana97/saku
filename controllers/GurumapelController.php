...
use app\models\GurumapelSearch;
...
class GurumapelController extends Controller
{
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Gurumapel",
                    'content'=>'<span class="text-success">Create Gurumapel success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_guru_mapel]);
            } else {
    ...
    {
        if (($model = Gurumapel::findOne($id)) !== null) {
            return $model;
        } else {
