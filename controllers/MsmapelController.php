...
class MsmapelController extends Controller
{
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Create new Msmapel",
                    'content'=>'<span class="text-success">Create Msmapel success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->id_msmapel]);
            } else {
    ...
    {
        if (($model = Msmapel::findOne($id)) !== null) {
            return $model;
        } else {
